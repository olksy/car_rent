                                ...
                                <>
                                    ...
                                    >
                                        <div className="gallery-item-link first-image cursor-pointer h-100">
                                            <img
                                                style={{ width: "100%" }}
                                                // src={image.path ? `${pathToImg}/${data.id}/${image.path}` : `${pathToImg}/default_image.png`}
                ...
                <div className="pt-4 pt-lg-5">
                    <div className="tab-content">
                        ...
                        <p className="text-justify fs-14 mb-5">
                            ...
                            includes basic insurance and standard mileage limit
                            of 250 km/day (with overlimit charge € 3 per
                            additional km). Security deposit no needed. So,
                        ...
                        <div className="w-100 mb-5">
                            <a
                                ...
                                href={`/cars/${data.category.name.toLowerCase()}`}
                            >
